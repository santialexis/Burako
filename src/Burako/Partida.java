...
public class Partida {
            ...
            switch (opcion) {
                case 1:
                    if(!tomoFicha){
                        ...
                        System.out.println("Ya se levantaron fichas!");
                    }
                    break;
    ...
    private Jugada armarJugada(Jugador jugador){
        ...
        System.out.println("Seleccione las fichas de la jugada (numero + color) (\"comodin\" para comodines de 50)");
        ...
        System.out.println("Bajando jugada...");
        return jugada;
    }
